...
ggplot() + 
  ...
  labs(title = "Comparison of Lobster size in 2012 vs 2018",
       x = "Catch site",
       y = "") +
    scale_y_continuous(breaks = c(82.55),labels = c(str_wrap("Miniumum Catch Size (82.55mm)",width = 10)))+
...
names(t_table) <-  c("estimate",
          ...
          "method",
          "alternative",
          "percent_difference", "total_difference")
...
[1] Lobster, Spiny. Minimum Size and Verification, 14 CA ADC § 121.5 (2017).
