...
visuals <- cbind(lob_size_2012_test$site,lob_size_2012_test$size_mm,
                 lob_size_2018_test$site,lob_size_2018_test$size_mm)
  
#ggplot(lob_size_2012_test, 
    #   aes (x = site, y = size_mm, fill = site)) +
  #geom_violin() +
  #ggplot(lob_size_2018_test, (aes(x = site, y = size_mm, fill = site))) +
  #geom_violin()
